...
INSERT INTO menu_items (category, name, price, is_available, description, pairing, terpenes, format, tags) VALUES
  ('The Reserve', 'The Punchcard', 12.00, TRUE, 'Earthy, woodsy, grounding. Myrcene forward with a hint of black pepper. The strain of the working class. Clocks in, never clocks out.', 'The Daily Grind — the bitterness cuts right through the earthiness and opens everything up.', 'Myrcene, Caryophyllene, Pinene', 'Raw Flower', ARRAY['hypoallergenic']),
  ('The Reserve', 'Limonene Dreams', 14.00, TRUE, 'Bright citrus, lemon rind, fresh cut grass. Sativa leaning. Makes the pour over taste like sunlight.', 'The Kessel Pour — single origin fruit notes and limonene are the same frequency.', 'Limonene, Terpinolene, Ocimene', 'Raw Flower', ARRAY['hypoallergenic']),
  ('The Reserve', 'Myrcene Nightcap', 13.00, TRUE, 'Mango, tropical, deeply sedating. The last thing before the lights go out. Soft landing.', 'The Force Chamomile — chamomile''s apigenin and myrcene''s sedation are a love story.', 'Myrcene, Linalool, Bisabolol', 'Raw Flower', ARRAY['hypoallergenic']),
  ('The Reserve', 'Terpinolene Raw Flower', 13.00, TRUE, 'Fresh, piney, floral, slightly herbal. The most underrated terpene. Pairs with anything clean.', 'Peppermint Rebellion — two clean profiles, one clear head.', 'Terpinolene, Ocimene, Myrcene', 'Raw Flower', ARRAY['hypoallergenic']),
  ('The Reserve', 'The Balanced Force', 10.00, TRUE, 'Hybrid. Equal indica and sativa energy. Like a cortado — neither side wins, both sides thrive.', 'May the Cortado Be With You — balance meets balance. The Force approves.', 'Caryophyllene, Myrcene, Limonene', 'Pipe', ARRAY['hypoallergenic']),
  ('The Reserve', 'Pinene Pipe Session', 10.00, TRUE, 'Sharp pine, forest floor, clarity. Alpha-pinene opens the lungs, opens the mind.', 'Yoda''s Green — pine and sencha share the same ancient forest.', 'Alpha-Pinene, Beta-Pinene, Terpinolene', 'Pipe', ARRAY['hypoallergenic']),
  ('The Reserve', 'Chocolate OG', 11.00, TRUE, 'Rich cocoa, coffee, dark earth. Indica dominant. Hits like a slow exhale after a long week.', 'The Hoth Blend — frozen mocha and chocolate OG is the dessert course you didn''t know you needed.', 'Myrcene, Caryophyllene, Linalool', 'Pipe', ARRAY['hypoallergenic']),
  ('The Reserve', 'The Jedi Kush', 15.00, TRUE, 'Pure flower, rice paper, twisted tip. Floral and earthy with a creamy finish. Rolled with intention.', 'Use the Foam Luke — oat milk latte softens the kush and the kush amplifies the latte. A loop of warmth.', 'Linalool, Myrcene, Caryophyllene', 'Joint', ARRAY['hypoallergenic']),
  ('The Reserve', 'Limonene Joint', 15.00, TRUE, 'Citrus forward flower, clean rice paper, no tobacco. Bright on the inhale, clean on the exhale.', 'Earl of the Republic — bergamot and limonene, two citrus forces walking the same road.', 'Limonene, Terpinolene, Pinene', 'Joint', ARRAY['hypoallergenic']),
  ('The Reserve', 'The Shop Steward', 15.00, TRUE, 'Robust, earthy, dependable. Rolled clean. The joint that shows up on time and stays late.', 'Solidarity Macchiato — espresso and caryophyllene have been negotiating flavor since the first harvest.', 'Caryophyllene, Myrcene, Humulene', 'Joint', ARRAY['hypoallergenic']),
  ('The Reserve', 'The Senator', 13.00, TRUE, 'Flower and light tobacco. Slow burning. Deliberate. Dark, direct, no distractions.', 'Order 66 (Decaf) — decaf''s roast depth plus tobacco''s smokiness. The dark side never smelled this good.', 'Myrcene, Caryophyllene, Guaiol', 'Spliff', ARRAY[]::text[]),
  ('The Reserve', 'Blue Dream Spliff', 13.00, TRUE, 'Blueberry forward flower with light Virginia tobacco. The tobacco lifts the berry notes without overwhelming.', 'Blue Milk Flat White — blueberry terpenes and oat milk flatness is the most gentle pairing on this menu.', 'Myrcene, Caryophyllene, Pinene', 'Spliff', ARRAY[]::text[]),
  ('The Reserve', 'The Spice Route', 13.00, TRUE, 'Caryophyllene heavy with pepper and clove, blended with light tobacco. Intentional from first light to last draw.', 'Rebel Chai — caryophyllene IS the spice. This pairing is not a suggestion. It is a revelation.', 'Caryophyllene, Humulene, Myrcene', 'Spliff', ARRAY[]::text[]),
  ('The Reserve', 'Citrus Haze Spliff', 13.00, TRUE, 'Haze-forward citrus flower with light tobacco. Energetic, uplifting, effervescent.', 'Sparkling Resistance — citrus on citrus, bubbles meeting limonene. The lightest pairing on the menu.', 'Limonene, Terpinolene, Pinene', 'Spliff', ARRAY[]::text[]),
  ('The Reserve', 'The Foreman', 18.00, TRUE, 'Full gram. Natural leaf wrap. Slow burn. The blunt that runs the whole job site.', 'Double Shift — a double shot and a full gram. For the person who is not here to play.', 'Myrcene, Caryophyllene, Linalool', 'Blunt', ARRAY[]::text[]),
  ('The Reserve', 'The Overthrower', 18.00, TRUE, 'Full gram, dark natural wrap, slow patient burn. Like cold brew — 18 hours in the making, gone in 45 minutes.', 'Cold Brew Coup — slow process, big payoff, shared ideology.', 'Myrcene, Ocimene, Caryophyllene', 'Blunt', ARRAY[]::text[]);
